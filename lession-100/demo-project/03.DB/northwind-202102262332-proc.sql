...
--
-- Temporary view structure for view `v_products_suppliers`
--

DROP TABLE IF EXISTS `v_products_suppliers`;
/*!50001 DROP VIEW IF EXISTS `v_products_suppliers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_products_suppliers` AS SELECT 
 1 AS `id`,
 1 AS `product_code`,
 1 AS `product_name`,
 1 AS `category`,
...
/*!50003 DROP PROCEDURE IF EXISTS `proc_create_product` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_create_product`(
...
--
-- Final view structure for view `v_products_suppliers`
--
...
/*!50001 VIEW `v_products_suppliers` AS select `p`.`id` AS `id`,`p`.`product_code` AS `product_code`,`p`.`product_name` AS `product_name`,`p`.`category` AS `category`,`p`.`list_price` AS `list_price`,`p`.`discontinued` AS `discontinued`,`p`.`quantity_per_unit` AS `quantity_per_unit`,`p`.`standard_cost` AS `standard_cost`,`s`.`company` AS `company`,`s`.`first_name` AS `first_name`,`s`.`email_address` AS `email_address` from (`products` `p` join `suppliers` `s` on((`p`.`supplier_ids` = `s`.`id`))) */;
...
-- Dump completed on 2021-02-26 23:32:09
